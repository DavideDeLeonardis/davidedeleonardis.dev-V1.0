export const translationsEn = {
   header: {
      ...
      contact: 'Contact me',
      curriculum: 'Resume',
      qr_code: require('../assets/images/resume/qrcode-EN.png'),
      resume: require('../assets/images/resume/resume-EN.pdf'),
   ...
   other_projects: {
      ...
      go_to_archive_link: 'Explore the archive and discover all my works!',
   },
   projects: {
      deliveboo: {
         short_d:
...
export const translationsIt = {
   header: {
      ...
      qr_code: require('../assets/images/resume/qrcode-IT.png'),
      resume: require('../assets/images/resume/resume-IT.pdf'),
   ...
   other_projects: {
      ...
      go_to_archive_link: "Esplora l'archivio e scopri tutti i miei lavori!",
   },
   projects: {
      deliveboo: {
         short_d:
